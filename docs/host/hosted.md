...
If you decide later to [setup your own server](self.md), you can do this and [migrate all
calendars](migrate.md) you use to the other server.

See also:

- [How to configure all calendar parameters](configure.md#configuring-the-default-calendar)
