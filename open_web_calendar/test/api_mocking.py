...
from responses import (
    RequestsMock,
    _recorder,  # requires open-web-calendar[test] extra
)
...
class Recorder:
    ...
    def save(self):
        ...
        self._recorder.dump_to_file(
            file_path=file_name, registered=registered
        )
...
class Recording:
    """Replay previous recordings."""

    def __init__(self):
        """Load a bunch of recordings."""
