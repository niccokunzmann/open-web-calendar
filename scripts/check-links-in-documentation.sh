...
linkchecker \
  -o text \
  -F html \
  --ignore-url='^https://polar.sh/niccokunzmann/open-web-calendar$|^https://antroposofiachile.net/home/$|^https://www.squid-cache.org/$|^https://www.cloudron.io/$|.canonical$|http://localhost:5000|http://192.168.178.7:8000|http://127.0.0.1:8000|//[^/]*\.onion/|/security/code-scanning/|//(www\.)?ngi\.eu|/translations/.*\.md\.po$|^https://github.com/niccokunzmann/open-web-calendar/blob/master/docs/.+.md$' \
  --check-extern \
